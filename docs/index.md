...
All drone configurations are bundled with `crazyflow.dynamics`. Available configurations: `cf2x_L250`, `cf2x_P250`, `cf2x_T350`, `cf21B_500`, `hb_x500`, and any drone returned by `crazyflow.available_drones`.
