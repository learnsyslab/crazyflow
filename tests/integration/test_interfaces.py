...
from crazyflow.control import Control, load_function_params, parametrize
...
def test_rotor_vel_interface():
    ...
    thrust_max = load_function_params(state2attitude, sim.drone)["thrust_max"]
    rpm2thrust = load_function_params(force_torque2rotor_vel, sim.drone)["rpm2thrust"]
